...
<li><a href="#">Single Course Page</a></li>
<li class="active">Course Video Page</li>
</ol>
</div>
</div>
</div>
...
<div class="row">
                    ...
                    <!-- <div style="margin: 0 auto" class=""> -->
                        <video width="1020" height="675" autoplay controls>
                            <source src="/Videos/{{$video->video_file}}" type="video/mp4">
                        </video>
                        <h2 style="text-align: center;font-weight: 700;" class="">{{$video->video_title}}</h5>
                        <p style="text-align: center;font-weight: 500;" class="">{{$video->video_description}} </p>
                    </div>
                    </div>

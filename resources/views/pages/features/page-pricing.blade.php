...
<div class="my_planPrice">2€ per month</div>
...
<div class="my_planPrice">12€ per month</div>
<a type="button" class="btn btn-default">Sign Up</a>
</div>
<div class="col-xs-4 my_planHeader my_plan3">
<div class="my_planTitle">Ultimate</div>
<div class="my_planPrice">43.75€ per month</div>
...
<div class="row my_featureRow">
<div class="col-xs-12 col-sm-4 my_feature col-xs-12">
<p>Access single courses</p>
</div>
<div class="col-xs-12 col-sm-8">
<div class="row">
<div class="col-xs-4 col-sm-4 my_planFeature my_plan1">
<i class="fa fa-close no_check"></i>
</div>
<div class="col-xs-4 col-sm-4 my_planFeature my_plan2">
<i class="fa fa-check my_check"></i>
</div>
